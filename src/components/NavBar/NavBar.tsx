        ...
        <nav className="relative flex w-full justify-between gap-6 rounded-2xl px-4 py-3 backdrop-blur-xl">
          ...
          >
            <ul className="flex w-full flex-col gap-y-1 px-6 py-4 text-base text-gray-800 lg:flex-row lg:items-center lg:gap-x-10 lg:px-0 lg:py-0 lg:text-white/90 dark:text-gray-200">
              {['الاسألة ', 'التواصل', 'الباقات'].map(item => (
                <li key={item}>
                  <Link
                    href="#"
            ...
            <div className="w-full px-2 py-2">
              {' '}
              <button className="relative w-full cursor-pointer rounded-full bg-gradient-to-l from-sky-400/80 from-5% via-sky-200/80 via-60% to-sky-200/90 to-80% px-8 py-2 font-bold text-sky-900 shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),_0_6px_20px_rgba(0,150,200,0.35)] ring-2 ring-white/70 backdrop-blur-lg transition-all duration-300 hover:scale-105 md:hidden">
                سجل الان
              </button>
            </div>
          </div>
          ...
          <div className="flex min-w-max items-center gap-x-3">
            <button className="relative flex hidden rounded-full bg-white/10 px-4 py-2 text-white ring-1 ring-white/30 transition hover:bg-white/20 md:block">
              سجل الان
            </button>
