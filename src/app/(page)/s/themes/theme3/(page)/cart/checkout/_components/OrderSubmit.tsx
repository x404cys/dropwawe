...
import OrderSubmitButton from '@/app/(page)/s/themes/theme2/_utils/Order-Submit-Button';
import OrderSubmitButtonPayment from '@/app/(page)/s/themes/theme2/_utils/Order-Submit-Button-Payment';
...
export default function OrderSubmi() {
  ...
  return (
    <section id="checkout-section bg-[#f9f6f3]" dir="rtl">
      <div className="container mx-auto py-8">
        <div className="flex flex-col">
          <div>
            <Card className="space-y-4 rounded-none border border-gray-200 bg-[#f9f6f3] p-5 font-light">
