...
export function productHasVariants(product: Pick<StorefrontProduct, 'colors' | 'sizes'>): boolean {
...
export function isSameCartLine(product: CartProductIdentity, target: CartProductIdentity): boolean {
  return (
