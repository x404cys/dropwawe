...
import ProductCard3 from '@/app/(page)/s/themes/theme2/_components/Product-Card/ProductCard';
import HeroBanner from '@/app/(page)/s/themes/theme2/_components/HeroBanner/HeroBanner';
