    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3 pb-2">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="ring-offset-background focus-visible:ring-ring bg-primary text-primary-foreground hover:bg-primary/90 inline-flex h-8 w-fit cursor-pointer items-center justify-center rounded-md px-4 text-xs font-semibold whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50">
      ...
      >
        <Textarea
          ...
          placeholder={
            t.store?.storeDescPlaceholder || 'صف متجرك للعملاء — ماذا تبيع؟ ما الذي يميزك؟'
          }
          maxLength={200}
          className="min-h-[90px] resize-none leading-relaxed"
        />
      </FieldBlock>
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-0.5 text-[11px] leading-relaxed">
            {t.store?.domainChangeSubwarning ||
              'سيتم إعادة احتساب إحصائيات الزيارات. إذا أردت الاحتفاظ بها، تواصل مع الدعم.'}
          </p>
        </div>
      </div>
    </div>
