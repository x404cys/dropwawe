    ...
    <div className="grid gap-6 sm:grid-cols-2">
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input value={phone} onChange={(e) => onPhoneChange(e.target.value)} placeholder="0770xxxxxxx" />
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input value={shippingPrice} onChange={(e) => onShippingPriceChange(e.target.value)} placeholder="5000 د.ع" />
          <Truck className="absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 text-gray-400" />
        </div>
        {fieldErrors.shippingPrice && <p className="mt-1 text-xs text-red-500">{fieldErrors.shippingPrice}</p>}
      </div>
