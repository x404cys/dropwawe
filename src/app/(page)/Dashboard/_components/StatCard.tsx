...
export default function StatCard({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="group">
      <div className="relative overflow-hidden rounded-2xl border border-accent bg-white p-6 transition-all duration-200 hover:border-gray-300/80 hover:shadow-md">
