  ...
  return (
    <Dialog>
      <DialogTrigger
        ...
        className="rounded-md bg-background px-4 py-2 text-white transition hover:bg-neutral-800"
      >
        {triggerText}
      </DialogTrigger>
      ...
      <DialogContent className="max-w-lg space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select onValueChange={handleCitySelect}>
            ...
            <SelectContent className="border border-neutral-200 bg-card shadow-lg">
              {loadingCities ? (
        ...
        <div className="space-y-2">
          ...
          <Select onValueChange={value => setRegion(value)} disabled={!city || loadingRegions}>
            ...
            <SelectContent className="max-h-60 overflow-auto border border-neutral-200 bg-card shadow-lg">
              {loadingRegions ? (
                <div className="p-3 text-sm text-neutral-500">{t.loading}</div>
              ) : filteredRegions.length === 0 ? (
                <div className="p-3 text-sm text-neutral-500">{t.noResults}</div>
              ) : (
