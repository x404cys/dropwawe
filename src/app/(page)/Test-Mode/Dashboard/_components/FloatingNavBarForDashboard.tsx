...
export default function FloatingNavBarForDashboard() {
  ...
  const profitPath = '/Test-Mode/Dashboard/profit';
  ...
  return (
    <>
      ...
      <div dir="rtl" className="fixed bottom-3 left-1/2 z-50 -translate-x-49 -translate-y-12">
