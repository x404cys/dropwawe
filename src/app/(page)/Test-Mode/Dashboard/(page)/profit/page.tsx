...
import { TrendingUp, Clock, WalletIcon } from 'lucide-react';
...
const fakeData: ProfitData = {
  totalProfit: 12500000,
  daily: [
    { day: '2025-01-01', profit: 120000 },
    { day: '2025-01-02', profit: 180000 },
    { day: '2025-01-03', profit: 95000 },
    { day: '2025-01-04', profit: 210000 },
  ],
  weekly: [
    { week: 'Week 1', profit: 1500000 },
    { week: 'Week 2', profit: 2100000 },
    { week: 'Week 3', profit: 1800000 },
  ],
  monthly: [
    { month: 'January', profit: 4200000 },
    { month: 'February', profit: 3800000 },
    { month: 'March', profit: 4500000 },
  ],
};

export default function ProfitPageFake() {
  const [data] = useState<ProfitData>(fakeData);
      ...
      <div dir="rtl" className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="flex flex-col gap-2">
            ...
            <select
              className="h-11 rounded-lg border bg-white px-4 text-sm"
          ...
          <div className="rounded-xl border bg-white p-6">
            ...
            <div className="max-h-[320px] space-y-1 overflow-y-auto">
              {dailyFiltered.length ? (
                dailyFiltered.map(d => (
                  <div key={d.day} className="flex justify-between border-b py-3 text-sm">
