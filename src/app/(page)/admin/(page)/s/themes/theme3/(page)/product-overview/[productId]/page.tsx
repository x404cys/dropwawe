...
export default function ProductPage() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#f9f6f3]">
      <div className="mx-auto max-w-3xl p-4 md:p-8">
        <div className="flex flex-col">
          <div className="animate-fade-in">
            <div className="bg-card shadow-elegant relative overflow-hidden">
              <img
                src={selectedImage}
                alt={product.name}
              ...
              />
              {product.discount > 0 && (
                <Badge className="absolute top-4 right-4 rounded-none bg-black/60 p-2">
          ...
          <div className="animate-slide-up items-center space-y-8 text-center">
            ...
            <div>
              <h3 className="mb-3 bg-[#f9f6f3] text-center font-semibold">حدد الكمية المطلوبة</h3>
